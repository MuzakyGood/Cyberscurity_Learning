...
<ol>
    <li>Information Gathering (Pengumpulan Informasi)</li>
    <li>Penemuan Vulnerability</li>
    <li>Pelaksanaan Exploit</li>
    <li>Pasca-eksploitasi</li>
</ol>

# Contoh Eksploitasi Terkenal
<ul>
    <li>Heartbleed (2014)</li>
    <li>EternalBlue (2017)</li>
</ul>

# Melindungi Sistem dari Eksploitasi
<ul>
    <li>Patching dan Pembaruan</li>
    <li>Anti-virus software</li>
    <li>Penetration Testing</li>
    <li>Monitoring dan Deteksi Intrusi</li>
</ul>
